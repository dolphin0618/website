	...
	guaguale = {
		...
		bindCanvas:function(img, index){
			...
			img.addEventListener('load',function(e){
				...
				_this.canvas[index].removeEventListener(tapstart, eventDown);
				_this.canvas[index].addEventListener(tapstart, eventDown);
				function eventDown(e){
					e.preventDefault();                 
					_this.canvas[index].addEventListener(tapmove, eventMove);
					_this.canvas[index].addEventListener(tapend, eventUp);
				}
				function eventUp(e){                 
					e.preventDefault();
					_this.canvas[index].removeEventListener(tapmove, eventMove);
					_this.canvas[index].removeEventListener(tapend, eventUp);
